...
const CaliforniaPrivacyContent = () => (
  <div className="legal-page california-privacy-content">
    <div className="container">
      <div className="heading">
        <h1>KEEP SECZ Privacy Notice for California Residents</h1>
        <h2>Effective Date: April 16, 2020</h2>
        <p>
      ...
      <div className="body">
        ...
        <p>
          Our Website may collect information that identifies, relates to,
          describes, references, is capable of being associated with, or could
          reasonably be linked, directly or indirectly, with a particular
          consumer or device (&ldquo; <strong>personal information</strong>
          &rdquo;). In particular, our Website collects the following categories
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                employment history, account number, credit card number, debit
        ...
        <p>
          KEEP SECZ obtains the categories of personal information listed above
        ...
        <ul>
          <li>
            ...
            example, if you request to be included on an email list or in a user
            group, we will use that personal information to respond to your
            request. If you provide your personal information to enter into a
            smart contract, we will use that information for that purpose. We
            may also save your information to facilitate your future use of our
            Network.
          </li>
          <li>
        ...
        <p>
          KEEP SECZ will not collect additional categories of personal
        ...
        <p>
          KEEP SECZ may disclose your personal information to a third party for
        ...
        <p>
          In the preceding twelve (12) months, Keep SECZ has not disclosed
        ...
        <p>
          In the preceding twelve (12) months, Keep SECZ has not sold personal
          information.
        </p>
        ...
        <p>
          You have the right to request that KEEP SECZ disclose certain
          ...
          verifiable consumer request (see Exercising Access, Data Portability,
          and Deletion Rights), we will disclose to you:
        </p>
        <ul>
          <li>
        ...
        <p>
          You have the right to request that KEEP SECZ delete any of your
          ...
          exception applies. You acknowledge and agree that we will not be able
          to delete transactional histories involving your Ethereum wallet
          address from the Ethereum Blockchain ledger.
        </p>
        <p>
        ...
        <ol>
          ...
          <li>
            ...
            (Cal. Penal Code § 1546 <em>et. seq.</em>).
          </li>
          <li>
        ...
        <p>
          ...
          deliver our written response to the email address from which you
          submit it.
        </p>
        <p>
        ...
        <p>
          We do not sell your personal information so there is no reason for you
        ...
        <p>
          California&apos;s &ldquo;Shine the Light&rdquo; law (Civil Code
          Section § 1798.83) permits users of our Website that are California
          ...
          purposes. We do not disclose personal information for marketing
          purposes so there is no need to make such a request.
        </p>
        <h2>Changes to Our Privacy Notice</h2>
        <p>
          KEEP SECZreserves the right to amend this privacy notice at our
          discretion and at any time. When we make changes to this privacy
          notice, we will post the updated notice on the Website and update the
        ...
        <p>
          ...
          which KEEP SECZ collects and uses your information, your choices and
