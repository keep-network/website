...
const PlayingForKeepsTermsContent = () => (
  <div className="legal-page playing-for-keeps-terms-content">
    <div className="container">
      <div className="heading">
        <h1>Playing for Keeps Terms of Use</h1>
        <h2>Last Updated April 12, 2020</h2>
      </div>
      <div className="body">
        <h1>Rules &amp; Rewards</h1>
        ...
        <ul>
          <li>User Demand. Higher rewards are paid for projects that will be demanded by the users.</li>
          <li>Quality of description. Higher rewards are paid for clear, well-written submissions.</li>
          <li>Quality of reproducibility. Please include test code, scripts and detailed instructions. The easier it is for us to reproduce and verify the vulnerability, the higher the reward. Please see the docs and repos to learn more about our test suite in the official <a href="https://docs.keep.network/run-random-beacon.html">documentation</a>.</li>
          <li>Quality of fix, if included. Higher rewards are paid for submissions with clear description of how to fix the issue.</li>
        </ul>
        <h2>Rules</h2>
        <ul>
          <li>This Game of Keeps follows Keeps Standard Disclosure Terms, which are summarized here.</li>
          <li>Each submission will be judged by a panel of independent judges. The number of selection of judges may change throughout the Game of Keeps.</li>
          <li>Judges will attempt to announce winners bi-weekly. However, this schedule may change based on a variety of factors, including the number of submissions.</li>
          <li>Issues or projects that have already been submitted by another user or are already known to the Keep team are not eligible for bounty rewards.</li>
          <li>Public disclosure of a vulnerability makes it ineligible for a bounty.</li>
          <li>You can start or fork a private chain for bug hunting. Please respect the Keep main and test networks and refrain from attacking them.</li>
          <li>Keep's core development team, employees and all other people paid by the Keep project, directly or indirectly, are not eligible for rewards.</li>
          <li>Anyone who works with the codebase as a professional Keep developer is not eligible for rewards.</li>
          <li>Keep websites or Keep Foundation infrastructure in general, are NOT part of the bounty program.</li>
          <li>Keep bounty program considers a number of variables in determining rewards. Determinations of eligibility, score and all terms related to an award are at the sole and final discretion of the Keep Foundation bug bounty panel.</li>
        </ul>
        <h2>Credentials:</h2>
        <p>There is only one simple way you can register for the Game of Keeps:</p>
        <ul>
          <li>Join the Keep Discord: <a href="https://discord.gg/wYezN7v">https://discord.gg/wYezN7v</a></li>
        </ul>
        <p>When submitting, please be sure to include email credentials and all recent IPs.</p>
        <h2>Focus Areas:</h2>
        <ul>
          <li>Documentation "for humans". Help more people stake</li>
          <li>Staking guides for different kinds of hardware</li>
          <li>Bug &amp; security reports</li>
          <li>Improvements to the Keep client &amp; contracts and the tBTC system</li>
          <li>Translations of documentation and websites</li>
          <li>Extensions to the Keep token dashboard</li>
          <li>a tBTC deposit explorer</li>
          <li>a tBTC liquidation auction dApp</li>
          <li>tBTC on Tornado Cash</li>
          <li>tBTC on DEXs, especially newer DEXs like Loopring</li>
          <li>a tBTC deposit widget based on tbtc.js, simplifying integration for new devs</li>
        </ul>
        <h2>General Exclusions:</h2>
        <ul>
          <li>Headers used to maintain session state (Session ID)</li>
          <li>Scheduled infrastructure changes</li>
          <li>
            <p>DDoS/DoS attacks</p>
            <ul>
              <li>Enumeration attacks require prior notification and approval</li>
            </ul>
          </li>
        </ul>
        <p>Keep wants to help you!</p>
        <p>If you have a great idea, something that you feel is close to exploitation, or if you'd like some information regarding the internal API, or generally have any questions regarding Keep that would help in your efforts, please create a submission and ask for that information.</p>
        <h2>Other Notes</h2>
        <h2>Safe Harbor</h2>
        <p>If conducting vulnerability research against this program, we consider this research to be:</p>
        <ul>
          <li>Authorized in accordance with the Computer Fraud and Abuse Act (CFAA) (and/or similar state laws), and we will not initiate or support legal action against you for accidental, good faith violations of this policy;</li>
          <li>Exempt from the Digital Millennium Copyright Act (DMCA), and we will not bring a claim against you for circumvention of technology controls;</li>
          <li>Exempt from restrictions in our Terms &amp; Conditions that would interfere with conducting security research, and we waive those restrictions on a limited basis for work done under this policy; and</li>
          <li>Lawful, helpful to the overall security of the Internet, and conducted in good faith. You are expected, as always, to comply with all applicable laws.</li>
        </ul>
        ...
        <ul>
          <li>Testing should be performed only on systems listed under the program brief 'Targets' section. Any other systems are Out Of Scope.</li>
          <li>Except when otherwise noted in the program brief, you should create accounts for testing purposes.</li>
          <li>Submissions must be made exclusively through Keep to be considered for a reward.</li>
          <li>Communication regarding submissions must remain within Keep and/or official Keep support channels for the duration of the disclosure process.</li>
          <li>Actions which affect the integrity or availability of program targets are prohibited and strictly enforced. If you notice performance degradation on the target systems, you must immediately suspend all use of automated tools.</li>
        ...
        <p>During the course of each program, the Keep team may communicate updates via:</p>
        <ul>
          <li>'Program Updates' section within the program</li>
          <li>Discord or other chat platforms</li>
          <li>Email</li>
        </ul>
        <p>If you have questions about a program or a specific submission, you may contact the Keep team via:</p>
        <ul>
          <li>Discord or other chat programs</li>
...
export default PlayingForKeepsTermsContent
