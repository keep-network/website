...
const allPressEntries = [
  ...
  {
    title:
      "Messari adds 11 new Disclosures Registry participants, surpassing 50 members",
    date: "August 20, 2019",
    source: "Messari",
    aboveTheFold:
  ...
  {
    title:
      "Keep collaborates with Electric Coin Co., Ethereum Foundation, & Iqlusion to bring interoperability to Zcash",
    date: "August 13, 2019",
    source: "Keep Blog",
    aboveTheFold:
      ...
      <div className="press-content">
        <PageSection id="title-container">
          <div className="title">
            ...
            <h3>
              For press inquiries, please contact us at social@keep.network
            </h3>
          </div>
        </PageSection>
        ...
        {allPressEntries.length > 10 &&
        this.state.pressEntries.length === 10 ? (
